...
if(argc==5 && !strcmp(argv[1],"generate")){
    ...
    int filedesc = open(argv[2], O_CREAT|O_WRONLY|O_TRUNC, S_IRUSR|S_IWUSR); //if doesnt exist-create, if does-del
    if(filedesc<0){printf("Can't create file!\n"); return 1;}
    ...
    if(close(filedesc)==0){return 0;} else {printf("Can't close the file\n"); return 1;}
}else{
    if(argc==6 && !strcmp(argv[1],"sort")){
        ...
        if(!strcmp(argv[5], "sys")){
            ...
            if(!strcmp(argv[5], "lib")){
               ...
               stopTime();
               printf("  User: %ld.%lds\n  System: %ld.%lds\n", endU.tv_sec, endU.tv_usec, endS.tv_sec, endS.tv_usec);
               if(fclose(f)==0){return 0;} else {printf("Can't close the file\n"); return 1;} 
        ...
        if(argc==7 && !strcmp(argv[1],"copy")){
            ...
            if(!strcmp(argv[6], "sys")){
                ...
                if(fileFrom<0){printf("Can't create file!\n"); return 1;}
